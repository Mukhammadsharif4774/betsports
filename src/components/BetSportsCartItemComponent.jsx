...
import {betebetAllProducts} from '../helpers/betebetProducts';

const BetSportsCartItemComponent = ({item}) => {
  ...
  const productImage = betebetAllProducts.find(
    p => p.name === item.name,
  )?.image;
...
export default BetSportsCartItemComponent;
